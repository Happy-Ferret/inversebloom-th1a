/*
	TH1A: Fast Positive Hash, aka "Позитивный Хэш" - just the fastest portable hash function.
	implementation copied from https://github.com/dgryski/go-t1ha
...
// TH1A is a struct which provides funcationality for TH1A Hash.
type TH1A struct {
	seed uint64
}

func (t *TH1A) Sum64(data []byte) uint64 {
	seed := t.seed
	var a uint64 = seed
